...
let users = [
  ...
  { id: "taeho", pw: "gkxogh", name: "하태호", coupon: [], tickets: [] },
  {
    ...
    coupon: [
      ...
      { id: "2", type: "fixed", value: 10000, count: 1, name: "만원 할인권" },
    ],
    tickets: [],
  },
];
...
let currentMovies = [
  {
    ...
    title: "좀비딸",
    age: "icons/age12.png",
    shortInfo: "2025.07.30 개봉 1시간 54분  코미디, 드라마",
...
올여름, 가장 유쾌한 극비 프로젝트가 시작된다!<br>`,
    poster: "movies/movie1.png",
    still: {
      0: "movies/movie1-1.png",
      1: "movies/movie1-2.png",
      2: "movies/movie1-3.png",
      3: "movies/movie1-4.png",
      4: "movies/movie1-5.png",
      5: "movies/movie1-6.png",
      6: "movies/movie1-7.png",
    },
    movieSchedule: [
      { time: "10:00", theater: "1관" },
      { time: "12:40", theater: "4관" },
      { time: "17:50", theater: "2관" },
      { time: "20:20", theater: "5관" },
    ],
  },

  {
    ...
    title: "이사",
    age: "icons/age0.png",
    shortInfo: "2025.07.23 개봉 2시간 5분  드라마",
...
몰래 꾸민 세 가족 여행<br>
엄마 아빠와 다시 함께 살 수 있을까?<br>`,
    poster: "movies/movie2.png",
    still: {
      0: "movies/movie2-1.png",
      1: "movies/movie2-2.png",
      2: "movies/movie2-3.png",
      3: "movies/movie2-4.png",
    },
    movieSchedule: [
      { time: "10:00", theater: "1관" },
      { time: "12:40", theater: "4관" },
      { time: "15:10", theater: "3관" },
      { time: "20:20", theater: "5관" },
    ],
  },

  {
    ...
    title: "델마와 루이스",
    age: "icons/age19.png",
    shortInfo: "2025.07.10 개봉 2시간 9분  드라마",
...
모든 틀을 부수고 삶을 선택한 그들의 가장 찬란한 질주, <델마와 루이스>`,
    poster: "movies/movie3.png",
    still: {
      0: "movies/movie3-1.png",
      1: "movies/movie3-2.png",
      2: "movies/movie3-3.png",
      3: "movies/movie3-4.png",
    },
    movieSchedule: [
      { time: "10:00", theater: "1관" },
      { time: "12:40", theater: "4관" },
...

  {
    ...
    title: "인생은 아름다워",
    age: "icons/age0.png",
    shortInfo: "2016.04.13 개봉 1시간 56분  코미디, 드라마, 전쟁",
...
세상에서 가장 위대한 거짓말이 시작된다!`,
    poster: "movies/movie4.png",
    still: {
      0: "movies/movie4-1.png",
      1: "movies/movie4-2.png",
      2: "movies/movie4-3.png",
      3: "movies/movie4-4.png",
      4: "movies/movie4-5.png",
    },
    movieSchedule: [
      { time: "12:40", theater: "4관" },
      { time: "15:10", theater: "3관" },
...

  {
    ...
    title: "발레리나",
    age: "icons/age19.png",
    shortInfo: "2025.08.06 개봉 2시간 5분  액션",
...
킬러들의 표적이 된 ‘이브’의 눈앞에 ‘존 윅’이 나타나는데…<br>`,
    poster: "movies/movie5.png",
    still: {
      0: "movies/movie5-1.png",
      1: "movies/movie5-2.png",
      2: "movies/movie5-3.png",
      3: "movies/movie5-4.png",
      4: "movies/movie5-5.png",
    },
    5: "movies/movie5-6.png",
    movieSchedule: [
      { time: "10:00", theater: "1관" },
      { time: "15:10", theater: "3관" },
      { time: "17:50", theater: "2관" },
