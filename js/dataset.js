...
// {0:"movies/movie1-1.png",1:"movies/movie1-2.png",2:"movies/movie1-3.png",3:"movies/movie1-4.png",4:"movies/movie1-5.png",5:"movies/movie1-6.png",6:"movies/movie1-7.png"}
//영화 관련 정보
let currentMovies = [
...
올여름, 가장 유쾌한 극비 프로젝트가 시작된다!<br>`,poster:"movies/movie1.png",still : "movies/movie1-1.png"},
...
몰래 꾸민 세 가족 여행<br>
엄마 아빠와 다시 함께 살 수 있을까?<br>`,poster:"movies/movie2.png"},
...
모든 틀을 부수고 삶을 선택한 그들의 가장 찬란한 질주, <델마와 루이스>`,poster:"movies/movie3.png"},
...
세상에서 가장 위대한 거짓말이 시작된다!`,poster:"movies/movie4.png"},
...
킬러들의 표적이 된 ‘이브’의 눈앞에 ‘존 윅’이 나타나는데…<br>`,poster:"movies/movie5.png"}
];
